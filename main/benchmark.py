...
def generate_accuracy(train_set_x, train_set_y, test_set_x, test_set_y, learning_rate, training_epochs, lower_bound,
                      upper_bound, model_folder, model_file,lay1num=8,lay2num=4):
    print("=========BENCH_MARK===========")
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(training_epochs):
            _, loss, = sess.run(
                ...
                feed_dict={net.X: train_set_x[:data_size],
                           net.Y: train_set_y[:data_size],net.keep_prob1:1.0,net.keep_prob2:1.0})
        ...
        train_y = sess.run(net.probability, feed_dict={net.X: train_set_x,net.keep_prob1:1.0,net.keep_prob2:1.0})
        train_acc = util.calculate_accuracy(train_y, train_set_y, False)

        test_y = sess.run(net.probability, feed_dict={net.X: test_set_x,net.keep_prob1:1.0,net.keep_prob2:1.0})
