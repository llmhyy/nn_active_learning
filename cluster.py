...
def calculate_largest(cluster, dimension, num_of_points):

    center = calculate_center(cluster, dimension, num_of_points)
    largest = 0
...
def calculate_center(cluster, dimension, num_of_points):
...
def get_point_from_cluster(cluster, num_to_be_added):
    ...
    centroid = calculate_center(cluster, dimension, num_of_points)
...
def clustering_is_valid(clusters):
    ...
    for cluster in clusters:
        ...
        centers.append(calculate_center(clusters[cluster], dimension, num_of_points))
        largest.append(calculate_largest(clusters[cluster], dimension, num_of_points))
